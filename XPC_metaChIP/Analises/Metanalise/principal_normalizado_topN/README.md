# Metanalise/principal_normalizado_topN — metanálise principal, COM normalização top-N (N=1000)
...
proteínas. Mesma seleção de estado/amostras que `Metanalise/principal_sem_normalizacao/` (XPC pooled WT,
...
**Uso recomendado:** checar se uma interseção que aparece em `Metanalise/principal_sem_normalizacao/`
...
**Conteúdo:** mesma estrutura de `Metanalise/principal_sem_normalizacao/` (gene_sets, jaccard, upset,
